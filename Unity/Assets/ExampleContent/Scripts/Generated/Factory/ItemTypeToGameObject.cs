...
namespace Genesis
{
	[CreateAssetMenu(fileName = "DefaultItemTypeToGameObject", menuName = "Genesis/Factory/ItemTypeToGameObject")]
	public sealed partial class ItemTypeToGameObject : ScriptableObject
	{
		[Serializable]
